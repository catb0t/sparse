...
*/
static size_t count_real_zero_ranges (const uint64_t* const array, const size_t len) {
  size_t ranges = 0;
...
size_t ns64_count_zero_ranges (const uint64_t* const array, const size_t len) {
  ...
  return count_real_zero_ranges(array, len) + ns64_count_adjc_nonzero_pairs(array, len);
}
...
static size_t* real_zero_ranges (const uint64_t* const array, const size_t len) {
  const size_t out_len = 2 * count_real_zero_ranges(array, len);
...
size_t* ns64_zero_ranges (const uint64_t* const array, const size_t len) {
  ...
  const size_t
    ...
    len_realranges = 2 * count_real_zero_ranges(array, len),
    len_adjc_pairs = ns64_count_adjc_nonzero_pairs(array, len);

  size_t
    * const realranges = real_zero_ranges(array, len),
